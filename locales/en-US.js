  ...
  pages: {
    ...
    index: {
      ...
      sections: {
        about: {
          message:
            'Hello, Myself {author} and I am 25 years young. I am a ➼ Full Stack Developer with a keen interest in ➼ End to End Software Development. I am currently Masters in Computer Science from Heidelberg University, Germany majoring in ➼ Full Stack Web and ➼ Mobile App Development, ➼ Java Developer majorly focusing on ➼ REST Services & ➼ Micro-Services using ➼ Spring Framework & ➼ MySQL only with an aim of emerging as a connoisseur in order to further enhance my skills in the discipline of Computer Science. ➡ From past {years} years am engaged in the creation of design, layout and programming / building softwares and sites. I like to create something new, look for interesting solutions, do the impossible with simple code and bring my ideas and client ideas to life.',
          activity: {
            prepend:
            ...
            list: [
              ...
              {
                message:
                  'Studying UI / UX design and web and software development trends',
              },
              {
